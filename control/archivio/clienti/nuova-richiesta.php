<?php
        ...
        $stmt = $db->prepare("INSERT INTO richiesta (tipo_richiesta, id_tipo_immobile, sotto_tipo_1, sotto_tipo_2, sotto_tipo_3, sotto_tipo_4, sotto_tipo_5, localita, quartiere_1, quartiere_2, quartiere_3, quartiere_4, quartiere_5, costo_min, costo_max, superficie_min, piano_min, piano_max, vano_min, bagno_min, camera_letto_min, anno_costruzione_min, note, id_cliente) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        try {
            ...
            try {
              $id_richiesta = $db->lastInsertId();
              foreach($_POST['caratteristiche'] as $caratteristica){
                $stmt2 = $db->prepare("INSERT INTO richiesta_caratteristica (id_richiesta, id_caratteristica) VALUES (?,?)");
